...
CUDA_VISIBLE_DEVICES=4,5,6,7 python -m torch.distributed.run --nproc_per_node=4 train.py \
    ...
    --cond=0 \
    --arch=ddpmpp \
    --resume=/home/ubuntu/ext-mamba-illinois/yasi/Ambient/cifar10/cifar_pretrain/00001-cifar10-32x32-uncond-ddpmpp-edm-gpus4-batch512-fp32-NvJbu/training-state-050176.pt
