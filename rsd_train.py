...
from training import rsd_training_loop as training_loop
...
Pretrained Diffusion Models for One-Step Generation".
    ...
    torchrun --standalone --nproc_per_node=4 rsd_train.py \
    --alpha 1.2 \
    --cond 0 \
    --tmax 800 \
    --init_sigma 2.5 \
    --batch 256 \
    --batch-gpu 16 \
    --outdir 'image_experiment/rsd-train-runs/cifar10' \
...
# Initialize config dict.
    ...
    #The current RSD code only accepted pretrained edm checkpoint, needs to modify accordingly for the checkpoints of other types of diffusion models
    c.network_kwargs.class_name = 'training.networks.EDMPrecond'
    c.loss_kwargs.class_name = 'training.rsd_loss.RSD_EDMLoss'
