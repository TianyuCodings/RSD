...
from metrics import rsd_metric_main as metric_main
...
def training_loop(
    ...
    while True:
        ...
        for round_idx in range(num_accumulation_rounds):
            ...
            #TODO: do noisy adjustment for rsd loss
        ...
        for round_idx in range(num_accumulation_rounds):
            ...
            with misc.ddp_sync(fake_score_ddp, False):
                ...
                # TODO: RSDA also does not modify generator loss and generator discrimination loss.
