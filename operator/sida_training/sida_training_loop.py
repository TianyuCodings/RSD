...
def training_loop(
    ...
    while True:
        ...
        for round_idx in range(num_accumulation_rounds):
            ...
            real_images = dataset_item["image"].to(device)
            ...
            with misc.ddp_sync(G_ddp, False):
                ...
                with misc.ddp_sync(fake_score_ddp, (round_idx == num_accumulation_rounds - 1)):
                    if use_gan is False:
                        ...
                        # already modify this loss with ambient loss.
                        ...
                        loss,loss_D = loss_fn.fakescore_discriminator_share_encoder_loss(fake_score=fake_score_ddp, images=corrupted_images, current_sigma=current_sigma, labels=labels, augment_pipe=augment_pipe, real_images=real_images,true_score=true_score,alpha=alpha)
                        loss=loss.sum().mul(loss_scaling / batch_gpu_total)
