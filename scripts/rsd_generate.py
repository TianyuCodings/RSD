...
def main(**kwargs):
    ...
    python rsd_generate.py --outdir=image_experiment/out --seeds=0-49999 --batch=128 --network='https://huggingface.co/UT-Austin-PML/RSD/resolve/main/cifar10-uncond/alpha1.2/network-snapshot-1.200000-403968.pkl' --ref=https://nvlabs-fi-cdn.nvidia.com/edm/fid-refs/cifar10-32x32.npz

    #Cifar10 conditional, alpha=1.2
    python rsd_generate.py --outdir=image_experiment/out --seeds=0-49999 --batch=128 --network='https://huggingface.co/UT-Austin-PML/RSD/resolve/main/cifar10-cond/alpha1.2/network-snapshot-1.200000-713312.pkl' --ref=https://nvlabs-fi-cdn.nvidia.com/edm/fid-refs/cifar10-32x32.npz
    ...
    torchrun --standalone --nproc_per_node=4 rsd_generate.py --outdir=out --seeds=0-49999 --batch=128 --network='https://huggingface.co/UT-Austin-PML/RSD/resolve/main/imagenet64/alpha1.2/network-snapshot-1.200000-939176.pkl' --ref=https://nvlabs-fi-cdn.nvidia.com/edm/fid-refs/imagenet-64x64.npz

    #FFHQ 64x64, alpha=1.2
    torchrun --standalone --nproc_per_node=4 rsd_generate.py --outdir=out --seeds=0-49999 --batch=128 --network='https://huggingface.co/UT-Austin-PML/RSD/resolve/main/ffhq64/alpha1.2/network-snapshot-1.200000-498176.pkl' --ref=https://nvlabs-fi-cdn.nvidia.com/edm/fid-refs/ffhq-64x64.npz

    #AFHQ-v2 64x64, alpha=1
    torchrun --standalone --nproc_per_node=4 rsd_generate.py --outdir=out --seeds=0-49999 --batch=128 --network='https://huggingface.co/UT-Austin-PML/RSD/resolve/main/afhq64/alpha1/network-snapshot-1.000000-371712.pkl' --ref=https://nvlabs-fi-cdn.nvidia.com/edm/fid-refs/afhqv2-64x64.npz
    ...
    for batch_seeds in tqdm.tqdm(rank_batches, unit='batch', disable=(dist.get_rank() != 0)):
        ...
        # Generate images.
        sampler_kwargs = {}
        images = rsd_sampler(net, latents, class_labels, randn_like=rnd.randn_like,init_sigma=opts.init_sigma, **sampler_kwargs)
